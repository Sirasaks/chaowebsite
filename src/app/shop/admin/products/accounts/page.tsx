...
export default function AdminAccountsPage() {
    ...
    const getStockCount = (accountStr: string) => {
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h1 className="text-2xl font-bold">จัดการสินค้า (Account)</h1>
                                ...
                                filteredProducts.map((product) => (
                                    <TableRow key={product.id}>
                                        ...
                                        <TableCell className="text-center">
                                            <span className={`px-2 py-1 rounded-full text-xs ${getStockCount(product.account) > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                                                {getStockCount(product.account)} ชิ้น
                                            </span>
                                        </TableCell>
                                        <TableCell className="text-center">
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <Label>ข้อมูลบัญชี (1 บรรทัด = 1 ชิ้น)</Label>
                            <Textarea
