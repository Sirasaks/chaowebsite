...
export default function MasterTopupSlipPage() {
    ...
    const handleUpload = async (uploadFile: File) => {
        ...
        try {
            const res = await fetch("/api/master/topup/slip", {
                method: "POST",
                body: formData,
            });
                ...
                <CardContent className="space-y-6">
                    <div className="bg-card text-card-foreground border border-border rounded-lg p-4 shadow-sm space-y-3">
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-dashed">
                            ...
                            <span className="font-bold bg-blue-600 bg-clip-text text-transparent">10.00 บาท</span>
                        </div>
                    </div>
